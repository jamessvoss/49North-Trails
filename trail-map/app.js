...
const TRAILS = {
  'grewingk-glacier': {
    ...
    time: '1.5-2 hrs each way',
    difficulty: 'Easy',
    description: 'The most popular — and one of the easiest — hikes in Kachemak Bay State Park. From the Glacier Spit drop-off, a relatively flat 3.2-mile trail (6.4 mi roundtrip) winds through old-growth Sitka spruce and some of the park’s largest cottonwoods, then crosses open alluvial flats — watch for bald eagles and hawks — to a rocky beach on Grewingk Glacier Lake where electric-blue icebergs drift offshore. Return the way you came, or branch off at the Saddle Trail junction (mile 2.7) for a Halibut Cove water-taxi pickup.',
    highlights: ['Easy, mostly-flat hiking', 'Glacier lake with floating icebergs', 'Giant old-growth cottonwoods', 'Bald eagle & wildlife viewing'],
  ...
  'grewingk-tram': {
    name: 'Grewingk Creek Tram Trail',
    color: '#eab308',
    distance: '1.0 mi one-way',
    elevation: 'Mostly flat',
    time: '30-45 min',
    difficulty: 'Easy',
    description: 'A short, flat one-mile spur off the Grewingk Glacier Lake Trail leading to the famous hand-operated cable tram across Grewingk Creek. Pull yourself across the creek in the open-air cable car — a fun park highlight — to reach the Humpy Creek side and the longer alpine routes beyond.',
    highlights: ['Hand-operated cable tram crossing', 'Quick, flat connector', 'Grewingk Creek views', 'Gateway to Humpy Creek & alpine routes'],
    dropoff: 'Glacier Spit',
    waterTaxiTrail: 'Grewingk Glacier Lake Trail',
    image: 'grewingk-glacier.webp',
    camera: { center: [-151.155, 59.628], zoom: 13.5, pitch: 60, bearing: 180 }
  },
  'tutka-lake': {
...
map.on('load', () => {
  ...
  // Advisory labels (e.g., tidal warnings) — text-only, warning-yellow
  map.addLayer({
    id: 'advisory-labels',
    type: 'symbol',
    source: 'trails',
    filter: ['==', ['get', 'type'], 'advisory'],
    layout: {
      'text-field': ['get', 'name'],
      'text-size': 12,
      'text-font': ['Open Sans Bold'],
